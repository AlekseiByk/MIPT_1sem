...
#include <assert.h>
    ...
    #define ASSERTPTR(func, ptr)                                                                                        \
        do {                                                                                                            \
            if (ptr == nullptr)                                                                                         \
            {                                                                                                           \
                printf("ASSERT: " #func ": " #ptr " pointer is NULL");                                                  \
                abort();                                                                                                \
            }                                                                                                           \
        } while(0)
    ...
    #define ASSERTPTR(func, ptr)    do {} while(0)
